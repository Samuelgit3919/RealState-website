            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
                    {featuredProperties.map((property) => (
                        <div
                            key={property.id}
                            className="bg-[#FFFFFF] shadow-sm rounded-lg overflow-hidden shadow-elevation-1 hover:shadow-elevation-3
                       transition-all duration-300 ease-out micro-interaction group"
                        >
                           ...
                           ${savedProperties.has(property.id)
                                            ? 'bg-error text-white' : 'bg-white/90 text-text-[#64748B] hover:bg-white hover:text-error'
                                        }`}
                            ...
                            <div className="p-4 lg:p-6">
                                <div className="mb-3">
                                    <h3 className="text-lg font-semibold text-text-primary mb-1 group-hover:text-[#2563EB] transition-colors">
                                        {property.title}
                                    </h3>
                                    <p className="text-[#64748B] text-sm flex items-center">
                                ...
                                {/* Agent Info */}
                                <div className="flex items-center justify-between pt-4 border-t border-t-[#E5E7EB] border-border">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        />
                                        <span className="text-sm text-[#64748B]">{property.agent.name}</span>
                                    </div>
                ...
                <div className="text-center">
                    <Link
                        ...
                        className="inline-flex items-center px-8 py-3 bg-[#2563EB] text-white rounded-md font-semibold

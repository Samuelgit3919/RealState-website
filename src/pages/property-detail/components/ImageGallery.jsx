...
const ImageGallery = ({ images = [], title, virtualTour, video }) => {
    ...
    if (!images?.length) {
        return (
            <div className="w-full h-64 md:h-96 bg-[#F1F5F9] rounded-lg flex items-center justify-center">
                <div className="text-center">
                    <Icon name="ImageOff" size={48} className="text-[#64748B] mx-auto mb-2" />
                    <p className="text-[#64748B]">No images available</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-4">
            {/* Main Image */}
            <div className="relative w-full h-64 md:h-96 lg:h-[500px] overflow-hidden rounded-lg bg-[#FFFFFF]">
                <Image
                ...
                {images.length > 1 && (
                    <>
                        <button
                            ...
                            className="absolute left-4 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-[#FFFFFF]/90 rounded-full flex items-center justify-center hover:bg-[#FFFFFF] transition-all duration-200 shadow-elevation-2"
                        ...
                        <button
                            onClick={handleNext}
                            className="absolute right-4 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-[#FFFFFF]/90 rounded-full flex items-center justify-center hover:bg-[#FFFFFF] transition-all duration-200 shadow-elevation-2"
                ...
                {/* Image Counter */}
                <div className="absolute top-4 right-4 bg-[#FFFFFF]/90 px-3 py-1 rounded-md text-sm font-medium">
                ...
                <div className="absolute bottom-4 right-4 flex items-center space-x-2">
                    {virtualTour && (
                        <button
                            ...
                            className="flex items-center space-x-2 bg-[#FFFFFF]/90 hover:bg-[#FFFFFF] px-3 py-2 rounded-md text-sm font-medium transition-all duration-200"
                        >
                    ...
                    >
                        {images.map((image, index) => (
                            <button
                                ...
                                className={`flex-shrink-0 w-20 h-20 md:w-24 md:h-24 rounded-md overflow-hidden transition-all duration-200 ${index === currentImageIndex

                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all duration-200 ${errors.name ? 'border-error' : 'border-border focus:border-primary'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all duration-200 ${errors.email ? 'border-error' : 'border-border focus:border-primary'
                                            }`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all duration-200 ${errors.phone ? 'border-error' : 'border-border focus:border-primary'
                                        }`}
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleInputChange}
                                    rows={5}
                                    className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all duration-200 resize-vertical ${errors.message ? 'border-error' : 'border-border focus:border-primary'
                                        }`}
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 pt-4">
                                ...
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center space-x-2 px-6 py-3 rounded-md transition-all duration-200 ${isSubmitting

                ...
                <main className="pt-16 lg:pt-18">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        <div className="text-center">
                            <Icon name="Home" size={64} className="text-[#64748B] mx-auto mb-4" />
                            ...
                            <Link
                                ...
                                className="inline-flex items-center space-x-2 bg-[#2563EB] text-white px-6 py-3 rounded-md hover:bg-[#1D4ED8]transition-all duration-200"
                            >
    ...
    return (
        <div className="min-h-screen bg-[#FAFAFA]">
            ...
            <main className="pt-16 lg:pt-18">
                        ...
                        <nav className="flex items-center space-x-2 text-sm">
                            {getBreadcrumbs().map((crumb, index) => (
                                <React.Fragment key={index}>
                                    {index > 0 && (
                                        <Icon name="ChevronRight" size={14} className="text-[#64748B]" />
                                    )}
                                    {crumb.path ? (
                                        <Link
                                            to={crumb.path}
                                        ...
                                        <span className="text-[#2563EB] font-medium truncate">{crumb.label}</span>
                                    )}
                                </React.Fragment>
                            ))}
                        </nav>
                ...
                {/* Mobile Actions Bar */}
                <div className="lg:hidden bg-[#FFFFFF] border-b border-[#E2E8F0] sticky top-16 z-10">
                    <div className="px-4 py-3 flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            <button
                                onClick={handleSave}
                                className={`p-2 rounded-md transition-all duration-200 ${isSaved
                                    ? 'bg-[#DC2626] text-white' : 'bg-[#F1F5F9] text-[#64748B] hover:bg-[#DC2626] hover:text-white'
                                    }`}
                            >
                            ...
                            <button
                                onClick={handleShare}
                                className="p-2 bg-[#F1F5F9] text-[#64748B] rounded-md hover:bg-[#DBEAFE] transition-all duration-200"
                            >
                        ...
                        <div className="flex items-center space-x-2">
                            <button
                                ...
                                className="px-4 py-2 bg-[#0EA5E9] text-white rounded-md text-sm font-medium hover:bg-[#0284C7] transition-all duration-200"
                            >
                                Contact Agent
                            </button>
                            <button className="px-4 py-2 bg-[#2563EB] text-white rounded-md text-sm font-medium hover:bg-[#1D4ED8] transition-all duration-200">
                                Schedule Tour
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="lg:hidden">
                                <button
                                    ...
                                    className="w-full flex items-center justify-between p-4 bg-[#FFFFFF] border border-[#E2E8F0] rounded-lg hover:shadow-lg transition-all duration-200"
                                >
                                    <div className="flex items-center space-x-3">
                                        <Icon name="Calculator" size={20} className="text-[#2563EB]" />
                                        <span className="font-medium text-[#2563EB]">Mortgage Calculator</span>
                                    </div>
                                    <Icon
                                        name="ChevronDown"
                                        size={16}
                                        className={`text-[#64748B] transition-transform duration-200 ${showMortgageCalculator ? 'rotate-180' : ''
                                            }`}
                                    />
                                </button>
                            ...
                            <div className="card p-6 border border-[#E2E8F0]">
                                <div className="flex items-center space-x-4 mb-4">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="font-semibold text-[#2563EB]">{property.agent.name}</h3>
                                            ...
                                            <div className="flex items-center">
                                                {[...Array(5)].map((_, i) => (
                                                    <Icon
                                                        ...
                                                        name="Star"
                                                        size={14}
                                                        className={i < Math.floor(property.agent.rating) ? 'text-[#D97706] fill-current' : 'text-[#64748B]-300'}
                                                    />
                                                ))}
                                            </div>
                                ...
                                <div className="space-y-3">
                                    <button
                                        onClick={() => setShowContactForm(true)}
                                        className="w-full flex items-center justify-center space-x-2 bg-[#2563EB] text-white py-3 rounded-md hover:bg-[#1D4ED8] transition-all duration-200"
                                    >
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        <button className="flex items-center justify-center space-x-2 bg-[#E0F2FE] text-[#0284C7] py-2 rounded-md hover:bg-accent hover:text-white transition-all duration-200">
                                            <Icon name="Phone" size={16} />
                                            <span className="text-sm">Call</span>
                                        </button>
                                        <button className="flex items-center justify-center space-x-2 bg-[#F1F5F9] text-[#64748B] py-2 rounded-md hover:bg-[#DBEAFE] transition-all duration-200">

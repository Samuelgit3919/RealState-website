            ...
            <nav className="space-y-1 p-2">
                {tabs.map((tab) => (
                    <button
                        ...
                        className={`w-full flex items-center space-x-3 px-4 py-3 rounded-md text-left font-medium transition-all duration-200 micro-interaction focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${activeTab === tab.id

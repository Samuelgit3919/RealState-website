                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                        <div className="flex items-center space-x-3 mb-2">
                                            ...
                                            <div className="flex items-center space-x-1">
                                                <div className={`w-2 h-2 rounded-full ${search.isActive ? 'bg-success' : 'bg-secondary-300'
                                                    }`}></div>
                                                <span className={`text-sm ${search.isActive ? 'text-success' : 'text-text-secondary'
                                                    }`}>
                                    ...
                                    <div className="flex items-center space-x-2 ml-4">
                                        <button
                                            ...
                                            className={`p-2 rounded-md transition-colors duration-200 ${search.isActive

                        ...
                        <div className="py-2">
                            {tabs.map((tab) => (
                                <button
                                    ...
                                    className={`w-full flex items-center space-x-3 px-4 py-3 text-left transition-colors duration-200 focus:outline-none focus:bg-secondary-100 ${activeTab === tab.id
